import{a as m,S as y,i as d}from"./assets/vendor-b2578120.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&t(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();m.defaults.baseURL="https://pixabay.com/api/";const _=async(e,s=1,a=15)=>{const t={key:"42955810-525eb75005697c7b81a0edb8d",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:s};return await m.get("",{params:t})},l=document.querySelector(".images"),p=document.querySelector("#loader_place"),u=document.querySelector("#load_more_form"),L=new y(".images li a",{captionDelay:250,captionsData:"alt"}),b=()=>{p.innerHTML='<span class="loader"></span>'},v=()=>{p.innerHTML=""},S=()=>{u.classList.remove("visually-hidden")},w=()=>{u.classList.add("visually-hidden")},q=()=>{d.info({message:"We're sorry, but you've reached the end of search results!",position:"topRight"})},x=()=>{const e=document.querySelector(".image");if(e){const s=e.getBoundingClientRect().height;window.scrollBy({top:s*2,behavior:"smooth"})}},M=(e,s=!0)=>{if(s&&(l.innerHTML=""),e.hits.length===0)d.error({message:"Sorry, there are no images matching your search query. Please, try again!",position:"topRight"});else{const a=e.hits.map(t=>`<li class="image">
